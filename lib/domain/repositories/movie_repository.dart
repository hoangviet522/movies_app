...
abstract class MovieRepository {
  ...
  Future<Either<AppError, MovieEntity>> getMovieDetail(int id);
  Future<Either<AppError, List<VideoEntity>>> getVideoMovie(int id);
  Future<Either<AppError, List<MovieEntity>>> getSimilarMovie(int id);
}
